...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda pair: (pair[0],sum(pair[1])))
...
# TODO: Replace <FILL IN> with appropriate code
uniqueWords = wordCounts.keys().count()
print uniqueWords
...
def wordCount(wordListRDD):
    ...
    """
    wordCountsRDD = (wordListRDD
                     .map(lambda w: (w,1))
                     .reduceByKey(lambda a,b: a+b))
    return wordCountsRDD
...
def removePunctuation(text):
    ...
    # to lower case 
    # remove punctuations
    # remove leading and trailing spces
